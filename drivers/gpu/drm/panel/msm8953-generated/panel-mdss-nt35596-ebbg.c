...
static int nt35596_ebbg_on(struct nt35596_ebbg *ctx)
{
	...
	dsi_generic_write_seq(dsi, 0x00, 0x28);
	dsi_generic_write_seq(dsi, 0x01, 0x28);
	dsi_generic_write_seq(dsi, 0x02, 0x28);
	dsi_generic_write_seq(dsi, 0x03, 0x28);
	dsi_generic_write_seq(dsi, 0x04, 0x28);
	dsi_generic_write_seq(dsi, 0x05, 0x28);
	dsi_generic_write_seq(dsi, 0x06, 0x28);
	dsi_generic_write_seq(dsi, 0x07, 0x28);
	dsi_generic_write_seq(dsi, 0x08, 0x28);
	dsi_generic_write_seq(dsi, 0x09, 0x28);
	dsi_generic_write_seq(dsi, 0x0a, 0x28);
	dsi_generic_write_seq(dsi, 0x0b, 0x28);
	dsi_generic_write_seq(dsi, 0x0c, 0x28);
	dsi_generic_write_seq(dsi, 0x0d, 0x28);
	dsi_generic_write_seq(dsi, 0x0e, 0x28);
	dsi_generic_write_seq(dsi, 0x0f, 0x28);
	dsi_generic_write_seq(dsi, 0x10, 0x28);
	dsi_generic_write_seq(dsi, 0x11, 0x28);
	dsi_generic_write_seq(dsi, 0x12, 0x28);
	dsi_generic_write_seq(dsi, 0x13, 0x28);
	...
	dsi_generic_write_seq(dsi, 0x32, 0x96);
	dsi_generic_write_seq(dsi, 0x33, 0x95);
	dsi_generic_write_seq(dsi, 0x34, 0x14);
	dsi_generic_write_seq(dsi, 0x35, 0x14);
	dsi_generic_write_seq(dsi, 0x36, 0x14);
	dsi_generic_write_seq(dsi, 0x37, 0x17);
	dsi_generic_write_seq(dsi, 0x38, 0x1b);
	dsi_generic_write_seq(dsi, 0x39, 0x1d);
	dsi_generic_write_seq(dsi, 0x3a, 0x1c);
	dsi_generic_write_seq(dsi, 0x3b, 0x1b);
	dsi_generic_write_seq(dsi, 0x3f, 0x18);
	dsi_generic_write_seq(dsi, 0x40, 0x14);
	dsi_generic_write_seq(dsi, 0x41, 0x13);
	dsi_generic_write_seq(dsi, 0x42, 0x12);
	dsi_generic_write_seq(dsi, 0x43, 0x13);
	dsi_generic_write_seq(dsi, 0x44, 0x13);
	dsi_generic_write_seq(dsi, 0x45, 0x11);
	dsi_generic_write_seq(dsi, 0x46, 0x0d);
	dsi_generic_write_seq(dsi, 0x47, 0x09);
	dsi_generic_write_seq(dsi, 0x48, 0x07);
	dsi_generic_write_seq(dsi, 0x49, 0x07);
	dsi_generic_write_seq(dsi, 0x4a, 0x0f);
	dsi_generic_write_seq(dsi, 0x4b, 0x0c);
	dsi_generic_write_seq(dsi, 0x4c, 0x0e);
	...
	dsi_generic_write_seq(dsi, 0x54, 0x04);
	dsi_generic_write_seq(dsi, 0x55, 0x04);
	...
	dsi_generic_write_seq(dsi, 0xd3, 0x14);
	dsi_generic_write_seq(dsi, 0xd4, 0x08);
	dsi_generic_write_seq(dsi, 0x55, 0xb0);
